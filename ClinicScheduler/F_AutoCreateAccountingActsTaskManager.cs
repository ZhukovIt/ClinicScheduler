...
{
    public partial class F_AutoCreateAccountingActsTaskManager : Form
    {
        private CClinicApp m_clinicApp;
        private AppConfig m_config;
        private SiMedAutoCreateAccountingActsProperties m_Options;
        ...
        //---------------------------------------------
        public F_AutoCreateAccountingActsTaskManager(CClinicApp _ClinicApp, AppConfig _Config, SiMedAutoCreateAccountingActsProperties _Options, string _TaskName, string _SchedulerKey)
        {
        ...
        private void FillMembers()
        {
            if (m_Options != null)
            {
                ...
                chb_SignEDocuments.Checked = m_Options.SignEDocuments;
                chb_SendEDocuments.Checked = m_Options.SendEDocuments;
            }
        }
        //---------------------------------------------
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            if (CheckValidation())
            {
                ...
                m_Options.SignEDocuments = chb_SignEDocuments.Checked;
                m_Options.SendEDocuments = chb_SendEDocuments.Checked;
